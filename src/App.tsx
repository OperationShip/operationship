...
export default function App() {
  ...
  const [isUnitEconomicsOn, setIsUnitEconomicsOn] = useState(false);

  // 1. Register our custom node types
  const nodeTypes = useMemo(() => ({
    operationNode: OperationNode,
  }), []);

  // 2. High-Fidelity Dummy Data mapping perfectly to our Protocol
  const initialNodes = [
    { 
      id: 'node_1', 
      type: 'operationNode',
      ...
      data: { 
        ...
        description: 'Provides raw materials via JIT (Just-In-Time) logistics to minimize warehouse overhead.',
        status: 'active',
        tierRequired: 'free',
        isSelected: false,
        metrics: isUnitEconomicsOn ? { monthlyCost: 4500, riskScore: 8 } : null
      } 
    },
    { 
      id: 'node_2', 
      ...
      data: { 
        ...
        description: 'Automated legal structuring to reduce unnecessary cross-border tariffs.',
        status: 'ghost',
        tierRequired: 'pro',
        isSelected: true,
      } 
